						 ...
						 <v-tabs
				          ...
				          >
				            ...
				            <v-tab-item key="response" ripple>
				            	<v-card 
				            		v-if="(!options.nominals || options.nominals.length == 0)" 
				            		flat 
				            		color="transparent" 
				            		class="mt-3"
				            	> 
					            ...
					            <dj-priority v-if="answer" :list="answer.data" @update="onUpdateAnswer"></dj-priority>
						    </v-tab-item>
...
<script>
  ...
  import djPriority from "djvue/components/core/ext/dj-priority.vue"

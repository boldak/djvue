...
<script>
  ...
  import BarChartConfigDialog from "./bar-chart-config.vue";
  import echart from "djvue/components/core/ext/echart.vue"

  Vue.prototype.$dialog.component('BarChartConfigDialog', BarChartConfigDialog)
 ...
 export default  {
    ...
    methods:{
      ...
      onReconfigure (widgetConfig) {
       return this.$dialog.showAndWait(BarChartConfigDialog, {config:widgetConfig})
      },

    ...
    <v-container v-else>
      ...
      <div v-if="formConfig">
        <div v-for="(q, q_index) in formConfig.config.questions" class="mt-3">
          ...
          <p  v-if="q.options.type == 'One of many selection' || q.options.type == 'Many of many selection'" 
              class="body-1 secondary--text weight-light pl-3 ma-0"
          >

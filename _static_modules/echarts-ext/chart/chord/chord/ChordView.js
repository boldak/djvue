...
import * as echarts from 'modules/echarts/lib/echarts';
import RibbonPath from './Ribbon';
import * as graphic from 'modules/echarts/lib/util/graphic';
...
console.log("Chord view", data)
		...
		console.log("Sector", layout, sector)
            group.add(sector);
        });

 ...
 */
import * as zrUtil from 'modules/echarts/node_modules/zrender/src/core/util';
import {parsePercent} from 'modules/echarts/lib/util/number';
...
function layout(graphs, opts) {
    ...
    zrUtil.each(graphs, function (graph) {
        graph.eachEdge(function (edge) {
            ...
            g1.size += edge.getValue('value') || 1//0;
...
console.log("unitAngle",unitAngle, graph0.data.count(),sumSize)
...
console.log("endAngle", endAngle, group.size)
